...
public class EncryptRequestBodyAdvice implements RequestBodyAdvice {
	...
	public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType,
		...
		if (encrypt) {
			try {
				return new DecryptHttpInputMessage(inputMessage, secretKeyConfig.getAesHeaderName(),
						secretKeyConfig.getPrivateKey(), secretKeyConfig.getCharset(), secretKeyConfig.isShowLog());
			} catch (Exception e) {
